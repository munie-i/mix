...
function AnimationContent() {
    ...
    useEffect(() => {
        if (sort === 'popular') {
            fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${key}&include_adult=false&include_null_first_air_dates=false&language=en-US&page=${page}&sort_by=popularity.desc&with_genres=16`)
            .then((res) => res.json())
